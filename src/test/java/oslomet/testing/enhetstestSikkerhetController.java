...
public class enhetstestSikkerhetController {
    ...
    @Test
    public void sjekkLogin_UgyldigPassord(){
        //arrange
        //act
    ...
    @Test
    public void sjekkLogin_UgyldigPersonnummer(){
        //arrange
        //act
        String resultat = sikkerhetsController.sjekkLoggInn("12345678901a", "HeiHei");
    ...
    @Test
    public void sjekkLogin_FeilPassordEllerPersonnummer(){
        //arrange
    ...
    @Test
    public void loggInnAdmin_RettPassordOgBrukernavn(){
        //arrange
    ...
    @Test
    public void loggInnAdmin_FeilPassordOgBrukernavn(){
        //arrange

        //act
        String resultat = sikkerhetsController.loggInnAdmin("Admin1", "Admin2");
    ...
    @Test
    public void loggetInn_AtributtNull(){
        //arrange
